...
description_full: '<p>株式会社UZUMAKIはエンジニア・デザイナー・ディレクターで構成されるギルド型開発チームです。所属しているメンバーは、個人事業主や副業が許された正社員で構成され、互いに信頼がある関係を前提に、プロジェクト単位でチームを構成して仕事をします。web系の開発案件を、デザインやワイヤーフレーム作成段階から、rails, react,vue.js, aws, flutterをつかってまるっとチームで請け負って仕事をしております。<a href="https://job.uzumaki-inc.jp/">採用情報はこちら</a></p>'
